...
if ($_SESSION['loginin'] != '1') {
    ...
    if (empty($_GET['type']) || $_GET['type'] == "sub") {
        ...
        $userr->execute();
        $userrr = $userr->fetch(); ?>
<div id="content-infoname">
    <b><?php echo '<a href="id'.$userrr['id'].'">'.$userrr['name'].' '.$userrr['surname'].'</a>' ?> » Группы</b>
    <div style="float:right;"><?php if ($id == $_SESSION['id']) {?><a
            href="groups.php?type=created">Управление</a>&nbsp;&nbsp;<a href="search.php?type=groups">Поиск
            групп</a><?php } ?></div>
</div>
...
<div style="float:right;width:200px;margin-top:-8px;">
    <div style="margin:10px;"><?php if ($id == $_SESSION['id']) {?>
        ...
        <a id="aprofile" href="groups.php?type=sub&sort_by=date1&id=<?php echo $id; ?>">Сортировать по дате создания
            (увеличение)</a>
        <a id="aprofile" href="groups.php?type=sub&sort_by=date2&id=<?php echo $id; ?>">Сортировать по дате создания
            (убывание)</a>
    </div>
</div>
</div>
...
<?php
        ...
        $qs->execute(); ?>
<div id="content-infoname"><b>Группы (которыми вы управляете)</b>
    <div style="float:right;"><a href="groups.php?type=sub">Группы</a>&nbsp;&nbsp;<a href="search.php?type=groups">Поиск
            групп</a></div>
</div>
<div style="min-width:0;width:415px;min-height:165px;float:left;margin-top:-10px;border-right:#BEBEBE solid 1px;">
    <br>
