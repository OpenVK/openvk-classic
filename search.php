...
if(empty($_GET['type']) || $_GET['type'] == "users"){
...
$qs = $dbh1->prepare('SELECT * FROM users ORDER BY id DESC');
}elseif(empty($_GET['sort_by']) || $_GET['sort_by'] == "random"){
$qs = $dbh1->prepare('SELECT * FROM users ORDER BY RAND()');
}
$qs->execute();
?>
<div id="content-infoname"><b>Пользователи</b><div style="float:right;"><a href="search.php?type=groups&sort_by=random">Поиск групп</a>&nbsp;&nbsp;<a href="search.php?type=blog">Поиск по блогу</a>&nbsp;&nbsp;<a href="search.php?type=videos&sort_by=random">Поиск видеозаписей</a></div></div>
<div style="min-width:0;width:415px;float:left;margin-top:-10px;border-right:#BEBEBE solid 1px;">
  <?php if ($_GET['act'] == 'search' OR !empty($_GET['search'])) {?>
<br><form action="search.php"><input name="type" type="hidden" value="users"><input type="text" name="search" style="border: #6688A3 solid 1px;font-size: 11px;padding: 2px 2px 2px 17px;background: url(img/searchicon.png) no-repeat 3px 3px; background-color: #fff; margin-right: 5px;" placeholder="Поиск" size="40"><input type="submit" id="button" value="Найти!"></form><br>
  <?php } ?>
<br>
<?php
while($user = $qs->fetch()){
...
$ver = ' <img src="img/verify_hacker.png" width="12" height="12" style="margin-left:0;margin-right:0;margin-bottom:-2px;">';
}else{
$ver = '';
}
if($user['aboutuser2']){
...
<a id="aprofile" href="search.php?type=users&sort_by=random">Сортировать рандомно</a>
<a id="aprofile" href="search.php?type=users&sort_by=date1">Сортировать по дате регистрации (увеличение)</a>
<a id="aprofile" href="search.php?type=users&sort_by=date2">Сортировать по дате регистрации (убывание)</a>
</div>
</div>
</div>
<div>
...
$qs = $dbh1->prepare("SELECT * FROM club ORDER BY id DESC");
}elseif(empty($_GET['sort_by']) || $_GET['sort_by'] == "random"){
$qs = $dbh1->prepare("SELECT * FROM club ORDER BY RAND()");
}
$qs->execute();
?>
<div id="content-infoname"><b>Группы</b><div style="float:right;"><a href="search.php?type=users&sort_by=random">Поиск пользователей</a>&nbsp;&nbsp;<a href="search.php?type=blog">Поиск по блогу</a>&nbsp;&nbsp;<a href="search.php?type=videos&sort_by=random">Поиск видеозаписей</a></div></div>
<div style="min-width:0;width:415px;float:left;margin-top:-10px;border-right:#BEBEBE solid 1px;">
<br>

<form action="search.php"><input name="type" type="hidden" value="groups"><input type="text" name="search" style="border: #6688A3 solid 1px;font-size: 11px;padding: 2px 2px 2px 17px;background: url(img/searchicon.png) no-repeat 3px 3px; background-color: #fff; margin-right: 5px;" placeholder="Поиск" size="40"><input type="submit" id="button" value="Найти!"></form><br>
...
<div id="content-wall-post-text">
'.substr($group['about'], 0, 255).' '; if($group['about'] == null){echo'<i> <Информация не указана> </i>';}
echo ' 
</div>
</div>
</div>
...
<div style="float:right;width:200px;margin-top:-8px;">
<div style="margin:10px;">
<a id="aprofile" href="search.php?type=groups&sort_by=random">Сортировать рандомно</a>
<a id="aprofile" href="search.php?type=groups&sort_by=date1">Сортировать по дате создания (увеличение)</a>
<a id="aprofile" href="search.php?type=groups&sort_by=date2">Сортировать по дате создания (убывание)</a>
</div>
</div>
</div>
<div>
...
$qs = $dbh1->prepare("SELECT * FROM blog");
}elseif($_GET['sort_by'] == "date2"){
$qs = $dbh1->prepare("SELECT * FROM blog ORDER BY id DESC");
}elseif(empty($_GET['sort_by']) || $_GET['sort_by'] == "random"){
$qs = $dbh1->prepare("SELECT * FROM blog ORDER BY RAND()");
}
$qs->execute();
?>
<div id="content-infoname"><b>Блог</b><div style="float:right;"><a href="search.php?type=users&sort_by=random">Поиск пользователей</a>&nbsp;&nbsp;<a href="search.php?type=groups&sort_by=random">Поиск групп</a>&nbsp;&nbsp;<a href="search.php?type=videos&sort_by=random">Поиск видеозаписей</a></div></div>
<div style="min-width:0;width:415px;float:left;margin-top:-10px;border-right:#BEBEBE solid 1px;">
<br>
<?php
while($blog = $qs->fetch()){
if($blog['photo1']){
$av = $blog['photo1'];
$blog['photo1'] = ''.$blog['photo1'];
}else{
$blog['photo1'] = "img/camera_200.png";
$av = $blog['avatar'];
}
echo '<table border="0" style="font-size:11px;">
<tr>
<td width="75" style="vertical-align:top;"><img src="'.$blog['photo1'].'" width="75" height="auto"></td>
<td style="vertical-align:0;">
<div id="content-wall-post" style="width:320px;">
<div id="content-wall-post-infoofpost">
<div id="content-wall-post-authorofpost">
<b style="margin-right:3px;"><a href="blog_'.$blog['id'].'">'.$blog['name'].'</a></b>
</div>
<div id="content-wall-post-text">
'.$blog['k_about'].' '; if($blog['k_about'] == null){echo'<i> <Информация не указана> </i>';}
echo ' 
</div>
</div>
</div>
...
<div style="float:right;width:200px;margin-top:-8px;">
<div style="margin:10px;">
<a id="aprofile" href="search.php?type=blog&sort_by=random">Сортировать рандомно</a>
<a id="aprofile" href="search.php?type=blog&sort_by=date1">Сортировать по дате создания (увеличение)</a>
<a id="aprofile" href="search.php?type=blog&sort_by=date2">Сортировать по дате создания (убывание)</a>
</div>
</div>
</div>
<div>
...
include 'exec/leftmenu.php';
if($_GET['sort_by'] == "date1"){
$qs = $dbh1->prepare("SELECT * FROM video");
}elseif($_GET['sort_by'] == "date2"){
$qs = $dbh1->prepare("SELECT * FROM video ORDER BY id DESC");
}elseif(empty($_GET['sort_by']) || $_GET['sort_by'] == "random"){
$qs = $dbh1->prepare("SELECT * FROM video ORDER BY RAND()");
}
$qs->execute();
?>
<div id="content-infoname"><b>Видеозаписи</b><div style="float:right;"><a href="search.php?type=users&sort_by=random">Поиск пользователей</a>&nbsp;&nbsp;<a href="search.php?type=blog">Поиск по блогу</a>&nbsp;&nbsp;<a href="search.php?type=groups&sort_by=random">Поиск групп</a></div></div>
<div style="min-width:0;width:415px;float:left;margin-top:-10px;border-right:#BEBEBE solid 1px;">
<br>
<?php
   $qvideoscount = $dbh1->prepare("SELECT COUNT(1) FROM video");
		...
		<tbody>	
			<tr>
				<td width="120" style="vertical-align: top;">
					<div style="background:url(https://img.youtube.com/vi/'.$video['id_video'].'/0.jpg);background-size:100%;width:120px;height:90px;"></div>		
				</td>
				<td style="vertical-align: 0;">
					<div id="content-main-gray-content-info"><a href="video.php?id='.$video['id'].'"><b>'.$video['name'].'</b></a><br>'.$ab.'<br>Добавлено '.zmdate($video['date']).'<br></div>
				</td>
			</tr>
		</tbody>
		</table>
...
<div style="float:right;width:200px;margin-top:-8px;">
<div style="margin:10px;">
<a id="aprofile" href="search.php?type=videos&sort_by=random">Сортировать рандомно</a>
<a id="aprofile" href="search.php?type=videos&sort_by=date1">Сортировать по дате создания (увеличение)</a>
<a id="aprofile" href="search.php?type=videos&sort_by=date2">Сортировать по дате создания (убывание)</a>
</div>
</div>
</div>
<div>
