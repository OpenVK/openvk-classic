...
<? } ?>
<? if($club['closed'] != '2'){ ?>
<div id="content-infoname"><b><?php if($club['ban'] == '1') { echo "Сообщество заблокированно";}else if($club['verify'] > 0){echo "Официальное сообщество"; }else{echo "Сообщество";} ?></b><?php if ($club['verify'] == '1') {
