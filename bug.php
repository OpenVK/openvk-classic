...
<?php if ($bug['status'] != "2" and $bug['news'] != '0') { ?>
...
<?php
            ...
            echo '<meta charset="utf-8"><link rel="stylesheet" href="blank.css">
<div class="simpleBlock">
  ...
  <div class="simpleBar clearFix">
   ...
   Блокировка аккаунта тестера.<br>
        ...
        echo '<meta charset="utf-8">Извините, но баг-трекер работает только для тестеров.';
        exit();
    }
} else {
