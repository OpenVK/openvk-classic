...
$userrr = $userr->fetch();
?>
<div id="content-infoname"><b><?php echo '<a href="club'.$userrr['id'].'">'.$userrr['name'].'</a>' ?> » Альбомы</b><?php if($_SESSION['id'] == $userrr['authorid']){?><text style="font-size: 8pt; color: #aaa; float: right;"><a href="galbum_add.php?id=<?php echo $id;?>">Создать альбом</a></text><?php } ?></div>
<br>
<?php
