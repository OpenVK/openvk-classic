...
if($_POST['edit_interesyy']){
$quser = $dbh1->prepare("SELECT * FROM users WHERE id='".$_SESSION['id']."'");
$quser -> execute();
$userdata = $quser->fetch();
$q = "UPDATE users SET do='".$_POST['edit_do']."', interes='".$_POST['edit_interes']."', mus='".$_POST['edit_mus']."', films='".$_POST['edit_films']."', favorite_shows='".$_POST['edit_show']."', games='".$_POST['edit_games']."', book='".$_POST['edit_book']."', quo='".$_POST['edit_quo']."' WHERE login='".$userdata['login']."'";
$q1 = $dbh1->prepare($q);
$q1 -> execute();
$q1->fetch();
header("Location: edit_page.php");
...
?>
<div id="content-infoname"><b>Редактировать страницу</b></div>
<div>
  ...
  <li  id="GeneralInfoTab" class="SelectedTab"><a href="#" onclick=" _GeneralInfo(); return false;">Информация</a></li>
	<li  id="PasswordTab" class="Tab"><a href="#" onclick="_PasswordTab(); return false;">Интересы</a></li>
...
<tr><td style="width:150px;"><div style="float:right;padding-right:7px;color:#777;">Родной город:</div></td><td><input id="text" style="width:200px;" name="edit_city" <?php echo 'value="'.$userdata['city'].'"'; ?> ></td></tr>
<tr><td style="width:150px;"><div style="float:right;padding-right:7px;color:#777;">Город:</div></td><td><input id="text" style="width:200px;" name="edit_city2" <?php echo 'value="'.$userdata['city2'].'"'; ?> ></td></tr>
<tr><td style="width:150px;"><div style="float:right;padding-right:7px;color:#777;">Веб-сайт:</div></td><td><input id="text" style="width:200px;" name="edit_site" <?php echo 'value="'.$userdata['site'].'"'; ?> ></td></tr>
<tr><td style="width:150px;"><div style="float:right;padding-right:7px;color:#777;">Полит. взгляды:</div></td><td><input id="text" style="width:200px;" name="edit_pv" <?php echo 'value="'.$userdata['pv'].'"'; ?> ></td></tr>
<tr><td style="width:150px;"><div style="float:right;padding-right:7px;color:#777;">Религ. взгляды:</div></td><td><input id="text" style="width:200px;" name="edit_rv" <?php echo 'value="'.$userdata['rv'].'"'; ?> ></td></tr>
</table>
...
<table border="0" style="font-size:11px;">
<tr><td style="width:150px;"><div style="float:right;padding-right:7px;color:#777;">Семейное положение:</div></td><td><select style="width:200px;" name="edit_sp" style="width:120px;">
<option value="0" <?php if($userdata['sp'] == "0") {echo ' selected';} ?>>Неуказано</option>
  <option value="1"<?php if($userdata['sp'] == "1") {echo ' selected';} ?>><?php if($userdata['gender'] == 2){
        echo "Не замужем";
	  }else{
		 echo "Нe женат";
	  } ?>
<option value="2" <?php if($userdata['sp'] == "2") {echo ' selected';} ?>>Встречаюсь</option>
  <option value="3"<?php if($userdata['sp'] == "3") {echo ' selected';} ?>><?php if($userdata['gender'] == 2){
        echo "Помолвлена";
	  }else{
		 echo "Помолвлен";
	  } ?>
  <option value="4"<?php if($userdata['sp'] == "4") {echo ' selected';} ?>><?php if($userdata['gender'] == 2){
        echo "Замужем";
	  }else{
		 echo "Женат";
	  } ?>
	  <option value="5" <?php if($userdata['sp'] == "5") {echo ' selected';} ?>>В гражданском браке</option>
  <option value="6"<?php if($userdata['sp'] == "6") {echo ' selected';} ?>><?php if($userdata['gender'] == 2){
        echo "Влюблена";
	  }else{
		 echo "Влюблён";
	  } ?>
<option value="7" <?php if($userdata['sp'] == "7") {echo ' selected';} ?>>Всё сложно</option>
<option value="8" <?php if($userdata['sp'] == "8") {echo ' selected';} ?>>В активном поиске</option>
...
<h3><b>Интересы</b></h3>
<form action="edit_page.php" method="post">
<div style="margin-left:157px;"></div><table border="0" style="font-size:11px;">

<tbody>
    <tr><td style="width:150px;vertical-align: top;"><div style="float:right;padding-right:7px;color:#777;">Деятельность:</div></td><td><textarea id="text" style="width: 400px;height: 30px;" name="edit_do"><?php echo $userdata['do'];?></textarea></td></tr>
    <tr><td style="width:150px;vertical-align: top;"><div style="float:right;padding-right:7px;color:#777;">Интересы:</div></td><td><textarea id="text" style="width: 400px;height: 50px;" name="edit_interes"><?php echo $userdata['interes'];?></textarea></td></tr>
    <tr><td style="width:150px;vertical-align: top;"><div style="float:right;padding-right:7px;color:#777;">Любимая музыка:</div></td><td><textarea id="text" style="width: 400px;height: 50px;" name="edit_mus"><?php echo $userdata['mus'];?></textarea></td></tr>
    <tr><td style="width:150px;vertical-align: top;"><div style="float:right;padding-right:7px;color:#777;">Любимые фильмы:</div></td><td><textarea id="text" style="width: 400px;height: 50px;" name="edit_films"><?php echo $userdata['films'];?></textarea></td></tr>
    <tr><td style="width:150px;vertical-align: top;"><div style="float:right;padding-right:7px;color:#777;">Любимые теле-шоу:</div></td><td><textarea id="text" style="width: 400px;height: 50px;" name="edit_show"><?php echo $userdata['favorite_shows'];?></textarea></td></tr>
    <tr><td style="width:150px;vertical-align: top;"><div style="float:right;padding-right:7px;color:#777;">Любимые книги:</div></td><td><textarea id="text" style="width: 400px;height: 50px;" name="edit_book"><?php echo $userdata['book'];?></textarea></td></tr>
    <tr><td style="width:150px;vertical-align: top;"><div style="float:right;padding-right:7px;color:#777;">Любимые игры:</div></td><td><textarea id="text" style="width: 400px;height: 50px;" name="edit_games"><?php echo $userdata['games'];?></textarea></td></tr>
    <tr><td style="width:150px;vertical-align: top;"><div style="float:right;padding-right:7px;color:#777;">Любимые цитаты:</div></td><td><textarea id="text" style="width: 400px;height: 50px;" name="edit_quo"><?php echo $userdata['quo'];?></textarea></td></tr>
</tbody></table>
<br>
<div style="margin-left:157px;"><input type="submit" id="button" value="Сохранить" name="edit_interesyy"></div>
</form>
</div>
