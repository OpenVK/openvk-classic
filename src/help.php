...
<div id="content-infoname"><span style="font-weight:bold;color:#000000;">Помощь</span><div style="float:right;"><span style="font-style:italic;">последнее обновление: 15/11/2018 (DD/MM/YYYY)</span></div></div>
...
<div style="padding-left:16px;">
<a href="id2" style="font-size:24px;font-weight:bold;">Алексей Филатьев</a><br>
<span style="font-size:14px;color:#000000;">Тестер. Ищет баги и убивает их.</span>
</div>
</td>
</tr>
<tr>
...
<span style="font-size:14px;color:#000000;">Тестер. А также хороший друг :)</span>
</div>
</td>
    ...
    <tr>
        <td style="padding-top:16px;width:72px;vertical-align:top;">
            <?php
            $qt3 = $dbh1->prepare("SELECT avatar FROM users WHERE id = '5'");
            $qt3->execute();
            $t3 = $qt3->fetch();
            ?>
            <a href="id5"><img <?php echo 'src="'.$t3['avatar'].'"'; ?> width="70px" height="auto" style="border:1px dashed #000;"></a>
        </td>
<td style="vertical-align:0;padding-top:16px;">
        <div style="padding-left:16px;">
            <a href="id5" style="font-size:24px;font-weight:bold;">Иван Линдгрен</a><br>
            <span style="font-size:14px;color:#000000;">Либертарианец. PHP-деволопер.</span>
        </div>
    </td>
    </tr>
<tr>
...
<div id="faqcontent">На данный момент у нас пока нет обратной связи. Вы можете написать свою жалобу <a href="club1">сюда</a>.</div>
...
<div id="faqcontent">Опять же, на данный момент у нас нету обратной связи. Обращайтесь <a href="club1">сюда</a>. Вы можете использовать Русский или Украинский язык.</div>
<br>
</div>
</div>
<div>
