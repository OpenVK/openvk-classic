...
$userrr = $userr->fetch();
?>
<div id="content-infoname"><b><?php echo '<a href="id'.$userrr['id'].'">'.$userrr['name'].' '.$userrr['surname'].'</a>' ?> » Друзья</b><div style="float:right;"><a href="search.php?type=users&sort_by=random">Поиск пользователей (Добавить в друзья)</a></div></div>
...
if($user['id'] == ""){
echo '<div style="margin:0 -10px;padding:55px;"><center><img src="img/error.png"><br><br><b style="font-size:25px;">Вы одиноки...</b><br><text style="font-size:14px;"><a href="search.php?type=users&sort_by=random">Поищите себе друзей</a> и отправьте им заявку. Или примите входящие заявки, если они есть.</text></center></div>';
}
?>
</div>
...
<?php }?><a id="aprofile" href="friends.php?type=added&sort_by=random&id=<?php echo $id; ?>">Сортировать рандомно</a>
<a id="aprofile" href="friends.php?type=added&sort_by=date1&id=<?php echo $id; ?>">Сортировать по дате регистрации (увеличение)</a>
<a id="aprofile" href="friends.php?type=added&sort_by=date2&id=<?php echo $id; ?>">Сортировать по дате регистрации (убывание)</a>
</div>
</div>
</div>
<div>
...
if($user['id'] == ""){
echo '<div style="margin:0 -10px;padding:55px;"><center><img src="img/error.png"><br><br><b style="font-size:25px;">Здесь ничего нет...</b><br><text style="font-size:14px;"><a href="search.php?type=users&sort_by=random">Попробуйте найти себе друзей</a> и отправить им заявку. Давайте, Вы можете!</text></center></div>';
}
?>
</div>
<div style="float:right;width:200px;margin-top:-8px;">
...
<?php }elseif($_GET['type'] == "outcoming"){
include 'exec/datefn.php';
include 'exec/header.php';
include 'exec/leftmenu.php';
if($_GET['sort_by'] == "date1"){
