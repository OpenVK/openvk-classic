<?php
// обработка даты
// эта параша написана и л ь ю ш е й  и немножко дорабатывается в о в к о й
...
$text = "6 минут назад";       // вова: бля остроумно добавлять шутку про суидид, ну ты же в литературный клуб доки доки играешь,
}elseif(time() <= $datee+480){ // илья: так это давно было добавлено, тогда я не знал о ней
$text = "7 минут назад";	   // вова: пздц не знал
