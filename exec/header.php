...
if ($qst['password'] != md5($_SESSION['pass'], $md5_hash)) {
	# code...
  if ($qst['cssstyle'] == '2') {
   echo '<title>В Контакте</title>';
 }else{
  echo '<title>OpenVK</title>';
 }
...
exit();
 ...
 <div id="head">
  ...
  <div id="head-button" style="width: 3.5em"><a href="logout.php">выйти</a></div><div id="head-button" style="width: 4.0em"><a href="help.php">помощь</a></div><div id="head-button" style="width: 5.5em"><a href="invite.php">пригласить</a></div><div id="head-button" style="width: 3.5em"><a href="search.php">люди</a></div><div id="head-button" style="width: 4em"><a href="search.php?type=groups&sort_by=random">группы</a></div><div id="head-button" style="width: 3.3em"><a href="search.php?act=search">поиск</a></div><?php }elseif ($_SESSION['loginin'] != '1') {
      echo '
